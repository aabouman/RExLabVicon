...
void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "vicon_msg.proto", schemas, file_default_instances, TableStruct::offsets,
...
void AddDescriptorsImpl() {
  ...
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "vicon_msg.proto", &protobuf_RegisterTypes);
}
...
VICON::VICON()
  ...
  ::google::protobuf::internal::InitSCC(
      &protobuf_vicon_5fmsg_2eproto::scc_info_VICON.base);
  SharedCtor();
...
const ::google::protobuf::Descriptor* VICON::descriptor() {
  ::protobuf_vicon_5fmsg_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_vicon_5fmsg_2eproto::file_level_metadata[kIndexInFileMessages].descriptor;
}

const VICON& VICON::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_vicon_5fmsg_2eproto::scc_info_VICON.base);
...
::google::protobuf::Metadata VICON::GetMetadata() const {
  protobuf_vicon_5fmsg_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_vicon_5fmsg_2eproto::file_level_metadata[kIndexInFileMessages];
}
